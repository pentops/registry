...
var file_j5_registry_v1_topic_builder_proto_rawDesc = []byte{
	...
	0x76, 0x31, 0x2f, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x5f, 0x74, 0x70, 0x62, 0x62,
...
var file_j5_registry_v1_topic_builder_proto_goTypes = []interface{}{
...
func file_j5_registry_v1_topic_builder_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_j5_registry_v1_topic_builder_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_j5_registry_v1_topic_builder_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_j5_registry_v1_topic_builder_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_j5_registry_v1_topic_builder_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_j5_registry_v1_topic_builder_proto_msgTypes[3].OneofWrappers = []interface{}{}
	type x struct{}
