...
func (c *builderRequestTopicClient) Publish(ctx context.Context, in *PublishMessage, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/j5.registry.builder.v1.topic.BuilderRequestTopic/Publish", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *builderRequestTopicClient) BuildAPI(ctx context.Context, in *BuildAPIMessage, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/j5.registry.builder.v1.topic.BuilderRequestTopic/BuildAPI", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BuilderRequestTopic_Publish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/j5.registry.builder.v1.topic.BuilderRequestTopic/Publish",
	}
...
func _BuilderRequestTopic_BuildAPI_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/j5.registry.builder.v1.topic.BuilderRequestTopic/BuildAPI",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var BuilderRequestTopic_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "j5.registry.builder.v1.topic.BuilderRequestTopic",
...
func (c *builderReplyTopicClient) BuildStatus(ctx context.Context, in *BuildStatusMessage, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/j5.registry.builder.v1.topic.BuilderReplyTopic/BuildStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BuilderReplyTopic_BuildStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/j5.registry.builder.v1.topic.BuilderReplyTopic/BuildStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
