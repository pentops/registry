...
const (
	BuilderRequestTopic_Publish_FullMethodName  = "/j5.registry.builder.v1.topic.BuilderRequestTopic/Publish"
	BuilderRequestTopic_BuildAPI_FullMethodName = "/j5.registry.builder.v1.topic.BuilderRequestTopic/BuildAPI"
)
