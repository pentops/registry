...
const (
	GithubCommandService_ConfigureRepo_FullMethodName = "/o5.registry.github.v1.service.GithubCommandService/ConfigureRepo"
)
...
func (c *githubCommandServiceClient) ConfigureRepo(ctx context.Context, in *ConfigureRepoRequest, opts ...grpc.CallOption) (*ConfigureRepoResponse, error) {
	...
	err := c.cc.Invoke(ctx, GithubCommandService_ConfigureRepo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _GithubCommandService_ConfigureRepo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GithubCommandService_ConfigureRepo_FullMethodName,
	}
